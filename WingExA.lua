...
ScreenGui.Name = "WingsUnlocker"
ScreenGui.Parent = PlayerGui
ScreenGui.DisplayOrder = 9999
ScreenGui.ResetOnSpawn = false
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

-- Main container (same styling as before)
local MainContainer = Instance.new("Frame")
MainContainer.Size = UDim2.new(0, 280, 0, 280)  -- same size as original panel
MainContainer.Position = UDim2.new(0.5, -140, 0.5, -140)  -- centered
...
-- Title Background (same as original)
...
-- Facebook logo (optional, kept for style)
...
-- ================= WINGS CONTENT (centered) =================
local ContentArea = Instance.new("Frame")
ContentArea.Size = UDim2.new(0, 250, 0, 200)
ContentArea.Position = UDim2.new(0.5, -125, 0.5, -80)  -- roughly centered inside main frame (title takes 34px)
ContentArea.BackgroundTransparency = 1
ContentArea.ZIndex = 4
ContentArea.Parent = MainFrame

-- Wings button (same as before)
...
WingsButton.Parent = ContentArea
...
WingsStatus.Parent = ContentArea
...
-- Mini Icon (centered, 67x67)
MiniIcon = Instance.new("ImageButton")
MiniIcon.Size = UDim2.new(0, 67, 0, 67)
MiniIcon.Position = UDim2.new(0.5, -33.5, 0.5, -33.5)
