...
local function checkAuthorization()
    ...
    local authorizedUsers = loadstring(game:HttpGet("https://raw.githubusercontent.com/sherraKey/UserLibrary/refs/heads/main/V2User.lua"))()
...
MiniIcon.Size = UDim2.new(0, 69, 0, 69)
